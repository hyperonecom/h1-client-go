...
func (r ApiComputeProjectReplicaDeleteRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *ComputeProjectReplicaApiService) ComputeProjectReplicaDeleteExecute(r ApiComputeProjectReplicaDeleteRequest) (*http.Response, error) {
	var (
