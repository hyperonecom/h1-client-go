...
// WebsiteCredential struct for WebsiteCredential
...
func (o WebsiteCredential) MarshalJSON() ([]byte, error) {
...
type NullableWebsiteCredential struct {
	value *WebsiteCredential
	isSet bool
}

func (v NullableWebsiteCredential) Get() *WebsiteCredential {
	return v.value
}

func (v *NullableWebsiteCredential) Set(val *WebsiteCredential) {
	v.value = val
	v.isSet = true
}

func (v NullableWebsiteCredential) IsSet() bool {
	return v.isSet
}

func (v *NullableWebsiteCredential) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebsiteCredential(val *WebsiteCredential) *NullableWebsiteCredential {
	return &NullableWebsiteCredential{value: val, isSet: true}
}

func (v NullableWebsiteCredential) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebsiteCredential) UnmarshalJSON(src []byte) error {
	v.isSet = true
