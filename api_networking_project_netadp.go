...
func (r ApiNetworkingProjectNetadpMetricGetRequest) Execute() (*Metric, *http.Response, error) {
...
func (r ApiNetworkingProjectNetadpMetricListRequest) Execute() ([]Metric, *http.Response, error) {
...
func (r ApiNetworkingProjectNetadpMetricPointListRequest) Execute() ([]Point, *http.Response, error) {
...
*/
func (a *NetworkingProjectNetadpApiService) NetworkingProjectNetadpMetricPointList(ctx context.Context, projectId string, locationId string, netadpId string, metricId string) ApiNetworkingProjectNetadpMetricPointListRequest {
	return ApiNetworkingProjectNetadpMetricPointListRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []Point
func (a *NetworkingProjectNetadpApiService) NetworkingProjectNetadpMetricPointListExecute(r ApiNetworkingProjectNetadpMetricPointListRequest) ([]Point, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
