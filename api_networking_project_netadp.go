...
func (r ApiNetworkingProjectNetadpDeleteRequest) Execute() (*InlineResponseDefault, *http.Response, error) {
...
func (a *NetworkingProjectNetadpApiService) NetworkingProjectNetadpDeleteExecute(r ApiNetworkingProjectNetadpDeleteRequest) (*InlineResponseDefault, *http.Response, error) {
	var (
...
func (r ApiNetworkingProjectNetadpMetricSeriesListRequest) Execute() ([]Point, *http.Response, error) {
	return r.ApiService.NetworkingProjectNetadpMetricSeriesListExecute(r)
}
...
func (a *NetworkingProjectNetadpApiService) NetworkingProjectNetadpMetricSeriesListExecute(r ApiNetworkingProjectNetadpMetricSeriesListRequest) ([]Point, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "NetworkingProjectNetadpApiService.NetworkingProjectNetadpMetricSeriesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/networking/{locationId}/project/{projectId}/netadp/{netadpId}/metric/{metricId}/series"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterToString(r.projectId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"locationId"+"}", url.PathEscape(parameterToString(r.locationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"netadpId"+"}", url.PathEscape(parameterToString(r.netadpId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"metricId"+"}", url.PathEscape(parameterToString(r.metricId, "")), -1)
