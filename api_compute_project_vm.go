...
@return Metric
*/
func (a *ComputeProjectVmApiService) ComputeProjectVmMetricGet(ctx _context.Context, projectId string, locationId string, vmId string, metricId string) (Metric, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/compute/{locationId}/project/{projectId}/vm/{vmId}/metric/{metricId}"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", _neturl.QueryEscape(parameterToString(projectId, "")) , -1)
...
@return []Metric
*/
func (a *ComputeProjectVmApiService) ComputeProjectVmMetricList(ctx _context.Context, projectId string, locationId string, vmId string) ([]Metric, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
// ComputeProjectVmMetricPointListOpts Optional parameters for the method 'ComputeProjectVmMetricPointList'
type ComputeProjectVmMetricPointListOpts struct {
...
func (a *ComputeProjectVmApiService) ComputeProjectVmMetricPointList(ctx _context.Context, projectId string, locationId string, vmId string, metricId string, localVarOptionals *ComputeProjectVmMetricPointListOpts) ([]Serie, *_nethttp.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/compute/{locationId}/project/{projectId}/vm/{vmId}/metric/{metricId}/point"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", _neturl.QueryEscape(parameterToString(projectId, "")) , -1)
