...
func (r ApiComputeProjectVmMetricSeriesListRequest) Execute() ([]Point, *http.Response, error) {
	return r.ApiService.ComputeProjectVmMetricSeriesListExecute(r)
}
...
func (a *ComputeProjectVmApiService) ComputeProjectVmMetricSeriesListExecute(r ApiComputeProjectVmMetricSeriesListRequest) ([]Point, *http.Response, error) {
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ComputeProjectVmApiService.ComputeProjectVmMetricSeriesList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/compute/{locationId}/project/{projectId}/vm/{vmId}/metric/{metricId}/series"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterToString(r.projectId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"locationId"+"}", url.PathEscape(parameterToString(r.locationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"vmId"+"}", url.PathEscape(parameterToString(r.vmId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"metricId"+"}", url.PathEscape(parameterToString(r.metricId, "")), -1)
