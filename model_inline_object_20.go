...
func NewInlineObject20(key string, value string) *InlineObject20 {
	this := InlineObject20{}
	this.Key = key
	this.Value = value
	return &this
...
func (o *InlineObject20) GetValue() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject20) GetValueOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Value, true
...
func (o *InlineObject20) SetValue(v string) {
	o.Value = v
}
