...
// IamProjectTransferOpts Optional parameters for the method 'IamProjectTransfer'
type IamProjectTransferOpts struct {
    XIdempotencyKey optional.String
}
 ...
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param projectId Project Id
 * @param iamProjectTransfer
 * @param optional nil or *IamProjectTransferOpts - Optional Parameters:
 * @param "XIdempotencyKey" (optional.String) -  Idempotency key
@return Project
*/
func (a *IamProjectApiService) IamProjectTransfer(ctx _context.Context, projectId string, iamProjectTransfer IamProjectTransfer, localVarOptionals *IamProjectTransferOpts) (Project, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodPost
		localVarPostBody     interface{}
		localVarFormFileName string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/iam/project/{projectId}/actions/transfer"
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", _neturl.QueryEscape(parameterToString(projectId, "")) , -1)
	...
	// body params
	localVarPostBody = &iamProjectTransfer
	r, err := a.client.prepareRequest(ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
