...
func (r ApiNetworkingProjectFirewallDeleteRequest) Execute() (*http.Response, error) {
...
// Execute executes the request
func (a *NetworkingProjectFirewallApiService) NetworkingProjectFirewallDeleteExecute(r ApiNetworkingProjectFirewallDeleteRequest) (*http.Response, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"projectId"+"}", url.PathEscape(parameterToString(r.projectId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"locationId"+"}", url.PathEscape(parameterToString(r.locationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"firewallId"+"}", url.PathEscape(parameterToString(r.firewallId, "")), -1)
...
func (r ApiNetworkingProjectFirewallEgressDeleteRequest) Execute() (*http.Response, error) {
...
func (a *NetworkingProjectFirewallApiService) NetworkingProjectFirewallEgressDeleteExecute(r ApiNetworkingProjectFirewallEgressDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"locationId"+"}", url.PathEscape(parameterToString(r.locationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"firewallId"+"}", url.PathEscape(parameterToString(r.firewallId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"egressId"+"}", url.PathEscape(parameterToString(r.egressId, "")), -1)
...
func (r ApiNetworkingProjectFirewallEventGetRequest) Execute() (*Event, *http.Response, error) {
...
func (r ApiNetworkingProjectFirewallGetRequest) Execute() (*Firewall, *http.Response, error) {
...
func (r ApiNetworkingProjectFirewallIngressDeleteRequest) Execute() (*http.Response, error) {
...
func (a *NetworkingProjectFirewallApiService) NetworkingProjectFirewallIngressDeleteExecute(r ApiNetworkingProjectFirewallIngressDeleteRequest) (*http.Response, error) {
	...
	localVarPath = strings.Replace(localVarPath, "{"+"locationId"+"}", url.PathEscape(parameterToString(r.locationId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"firewallId"+"}", url.PathEscape(parameterToString(r.firewallId, "")), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"ingressId"+"}", url.PathEscape(parameterToString(r.ingressId, "")), -1)
...
func (r ApiNetworkingProjectFirewallTagDeleteRequest) Execute() (*http.Response, error) {
...
func (r ApiNetworkingProjectFirewallTagGetRequest) Execute() (*Tag, *http.Response, error) {
...
func (r ApiNetworkingProjectFirewallTagListRequest) Execute() ([]Tag, *http.Response, error) {
