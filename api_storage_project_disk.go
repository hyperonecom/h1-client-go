...
func (r ApiStorageProjectDiskMetricPointListRequest) Execute() ([]Point, *http.Response, error) {
...
*/
func (a *StorageProjectDiskApiService) StorageProjectDiskMetricPointList(ctx context.Context, projectId string, locationId string, diskId string, metricId string) ApiStorageProjectDiskMetricPointListRequest {
	return ApiStorageProjectDiskMetricPointListRequest{
		ApiService: a,
		ctx: ctx,
		projectId: projectId,
...
// Execute executes the request
//  @return []Point
func (a *StorageProjectDiskApiService) StorageProjectDiskMetricPointListExecute(r ApiStorageProjectDiskMetricPointListRequest) ([]Point, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
