...
func NewInlineObject24(key string, value string) *InlineObject24 {
	this := InlineObject24{}
	this.Key = key
	this.Value = value
	return &this
...
func (o *InlineObject24) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject24) GetKeyOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Key, true
...
func (o *InlineObject24) SetKey(v string) {
	o.Key = v
}

// GetValue returns the Value field value
func (o *InlineObject24) GetValue() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *InlineObject24) GetValueOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Value, true
...
func (o *InlineObject24) SetValue(v string) {
	o.Value = v
}
