...
func NewInlineObject13(name string) *InlineObject13 {
	this := InlineObject13{}
	this.Name = name
	return &this
}
...
func (o *InlineObject13) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *InlineObject13) GetNameOk() (*string, bool) {
	if o == nil  {
		return nil, false
	}
	return &o.Name, true
...
func (o *InlineObject13) SetName(v string) {
	o.Name = v
}
