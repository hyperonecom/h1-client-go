...
func (o *StorageProjectDiskCreate) GetSource() interface{} {
...
// and a boolean to check if the value has been set.
func (o *StorageProjectDiskCreate) GetSourceOk() (*interface{}, bool) {
	if o == nil || o.Source == nil {
		return nil, false
	}
...
func (o *StorageProjectDiskCreate) SetSource(v interface{}) {
	o.Source = &v
}
