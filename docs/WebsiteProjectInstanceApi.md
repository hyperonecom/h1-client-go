...
> Domain WebsiteProjectInstanceDomainCreate(ctx, projectId, locationId, instanceId).Domain(domain).Execute()
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceDomainListRequest struct via the builder pattern
...
> WebsiteEnv WebsiteProjectInstanceEnvGet(ctx, projectId, locationId, instanceId, envId).Execute()
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceLogListRequest struct via the builder pattern
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceMetricListRequest struct via the builder pattern
...
> WebsiteSideapp WebsiteProjectInstanceSideappGet(ctx, projectId, locationId, instanceId, sideappId).Execute()
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceSideappGetRequest struct via the builder pattern
...
> WebsiteSnapshot WebsiteProjectInstanceSnapshotCreate(ctx, projectId, locationId, instanceId).WebsiteSnapshot(websiteSnapshot).Execute()
...
> WebsiteProjectInstanceTagDelete(ctx, projectId, locationId, instanceId, tagId).Execute()
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceTagDeleteRequest struct via the builder pattern
...
> Tag WebsiteProjectInstanceTagGet(ctx, projectId, locationId, instanceId, tagId).Execute()
...
func main() {
    ...
    // response from `WebsiteProjectInstanceTagGet`: Tag
    fmt.Fprintf(os.Stdout, "Response from `WebsiteProjectInstanceApi.WebsiteProjectInstanceTagGet`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceTagGetRequest struct via the builder pattern
...
> []Tag WebsiteProjectInstanceTagList(ctx, projectId, locationId, instanceId).Execute()
...
func main() {
    ...
    // response from `WebsiteProjectInstanceTagList`: []Tag
    fmt.Fprintf(os.Stdout, "Response from `WebsiteProjectInstanceApi.WebsiteProjectInstanceTagList`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceTagListRequest struct via the builder pattern
...
> []Tag WebsiteProjectInstanceTagPut(ctx, projectId, locationId, instanceId).Tag(tag).Execute()
...
func main() {
    ...
    // response from `WebsiteProjectInstanceTagPut`: []Tag
    fmt.Fprintf(os.Stdout, "Response from `WebsiteProjectInstanceApi.WebsiteProjectInstanceTagPut`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceTagPutRequest struct via the builder pattern
...
> Website WebsiteProjectInstanceTransfer(ctx, projectId, locationId, instanceId).WebsiteProjectInstanceTransfer(websiteProjectInstanceTransfer).XIdempotencyKey(xIdempotencyKey).XDryRun(xDryRun).Execute()
...
func main() {
    ...
    locationId := "locationId_example" // string | Location Id
    instanceId := "instanceId_example" // string | Instance Id
    websiteProjectInstanceTransfer := *openapiclient.NewWebsiteProjectInstanceTransfer("Project_example") // WebsiteProjectInstanceTransfer | 
    xIdempotencyKey := "xIdempotencyKey_example" // string | Idempotency key (optional)
    xDryRun := "xDryRun_example" // string | Dry run (optional)
    ...
    // response from `WebsiteProjectInstanceTransfer`: Website
    fmt.Fprintf(os.Stdout, "Response from `WebsiteProjectInstanceApi.WebsiteProjectInstanceTransfer`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceTransferRequest struct via the builder pattern
...
> Website WebsiteProjectInstanceUpdate(ctx, projectId, locationId, instanceId).WebsiteProjectInstanceUpdate(websiteProjectInstanceUpdate).Execute()
...
func main() {
    ...
    // response from `WebsiteProjectInstanceUpdate`: Website
    fmt.Fprintf(os.Stdout, "Response from `WebsiteProjectInstanceApi.WebsiteProjectInstanceUpdate`: %v\n", resp)
}
```
...
Other parameters are passed through a pointer to a apiWebsiteProjectInstanceUpdateRequest struct via the builder pattern
