...
type ApiIamOrganisationNotificationGetRequest struct {
	ctx context.Context
	ApiService *IamOrganisationApiService
	organisationId string
...
func (r ApiIamOrganisationNotificationGetRequest) Execute() (*Notification, *http.Response, error) {
	return r.ApiService.IamOrganisationNotificationGetExecute(r)
}

/*
IamOrganisationNotificationGet Get iam/organisation.notification
...
Get iam/organisation.notification
 ...
 @return ApiIamOrganisationNotificationGetRequest
*/
func (a *IamOrganisationApiService) IamOrganisationNotificationGet(ctx context.Context, organisationId string, notificationId string) ApiIamOrganisationNotificationGetRequest {
	return ApiIamOrganisationNotificationGetRequest{
		ApiService: a,
		ctx: ctx,
		organisationId: organisationId,
...
// Execute executes the request
//  @return Notification
func (a *IamOrganisationApiService) IamOrganisationNotificationGetExecute(r ApiIamOrganisationNotificationGetRequest) (*Notification, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamOrganisationApiService.IamOrganisationNotificationGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam/organisation/{organisationId}/notification/{notificationId}"
	localVarPath = strings.Replace(localVarPath, "{"+"organisationId"+"}", url.PathEscape(parameterToString(r.organisationId, "")), -1)
...
type ApiIamOrganisationNotificationListRequest struct {
	ctx context.Context
	ApiService *IamOrganisationApiService
	organisationId string
}
...
func (r ApiIamOrganisationNotificationListRequest) Execute() ([]Notification, *http.Response, error) {
	return r.ApiService.IamOrganisationNotificationListExecute(r)
}

/*
IamOrganisationNotificationList List iam/organisation.notification

List iam/organisation.notification

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @param organisationId Organisation Id
 @return ApiIamOrganisationNotificationListRequest
*/
func (a *IamOrganisationApiService) IamOrganisationNotificationList(ctx context.Context, organisationId string) ApiIamOrganisationNotificationListRequest {
	return ApiIamOrganisationNotificationListRequest{
		ApiService: a,
		ctx: ctx,
		organisationId: organisationId,
...
// Execute executes the request
//  @return []Notification
func (a *IamOrganisationApiService) IamOrganisationNotificationListExecute(r ApiIamOrganisationNotificationListRequest) ([]Notification, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IamOrganisationApiService.IamOrganisationNotificationList")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/iam/organisation/{organisationId}/notification"
	localVarPath = strings.Replace(localVarPath, "{"+"organisationId"+"}", url.PathEscape(parameterToString(r.organisationId, "")), -1)
